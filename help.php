<!DOCTYPE html>
<html lang="en" class=" js no-touch no-android chrome no-firefox no-iemobile no-ie no-ie10 no-ie11 no-ios"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<section id="content">
 ...
 <div class="container">
  ...
  <div class="clearfix">	  
	<div class="row m-b-xl">
	  <div class="col-sm-4 animated fadeInLeftBig">
	    <section class="panel b-light text-center m-t">
          ...
          <a href="help/win.php"><i> <img src="./theme/freedom/images/jiaocheng/1.png" data-evernote-hover-show="true"></i></a>
        </header>
        <a href="help/win.php">  
	...
	<section class="panel b-light text-center m-t">
	<header class="panel-heading bg-primary b-light">
        <a href="help/android.php"><i> <img src="./theme/freedom/images/jiaocheng/2.png" data-evernote-hover-show="true"></i>
        
         </a></header><a href="help/android.php">  
       <li class="list-group-item">
            Android配置影梭教程
       </li>
	  </a>	
	...
	<div class="row m-b-xl">
	  <div class="col-sm-4 animated fadeInLeftBig">
	    <section class="panel b-light text-center m-t">
    	  <header class="panel-heading bg-primary b-light">
          <a href="help/ios8.php"><i> <img src="./theme/freedom/images/jiaocheng/4.png" data-evernote-hover-show="true"></i>
		  </a></header><a href="help/ios8.php">  
       <li class="list-group-item">
            iOS8配置影梭教程
       </li>
	  </a>	
	...
	<section class="panel b-light text-center m-t">
	<header class="panel-heading bg-primary b-light">
        <a href="help/mac.php"><i> <img src="./theme/freedom/images/jiaocheng/5.png" data-evernote-hover-show="true"></i>
        
         </a></header><a href="help/mac.php">  
       <li class="list-group-item">
            Mac OS X使用配置影梭教程
       </li>
	  </a>	
	...
	<section class="panel b-light text-center m-t">
	<header class="panel-heading bg-primary">
        <a href="help/wifi.php"><i> <img src="./theme/freedom/images/jiaocheng/6.png" data-evernote-hover-show="true"></i>
        
         </a></header><a href="help/wifi.php">  
       <li class="list-group-item">
            极路由安装插件配置影梭ss教程
       </li>
	  </a>	
	...
	<div class="row m-b-xl">
	  <div class="col-sm-4 animated fadeInLeftBig">
	    <section class="panel b-light text-center m-t">
    	  <header class="panel-heading bg-primary b-light">
          <a href="help/sockscap64.php"><i> <img src="./theme/freedom/images/jiaocheng/7.png" data-evernote-hover-show="true"></i>
		  </a></header><a href="help/sockscap64.php">  
       <li class="list-group-item">
            SOCKSCAP64实现影梭全局代理外服教程
       </li>
	  </a>	
       </section> 
     </div>
...
<div class="col-sm-4 animated fadeInUp">
	<section class="panel b-light text-center m-t">
	<header class="panel-heading bg-primary b-light">
        <a href="help/ps4.php"><i> <img src="./theme/freedom/images/jiaocheng/4.png" data-evernote-hover-show="true"></i>
        
         </a></header><a href="help/ps4.php">  
       <li class="list-group-item">
            PSV/PS4/PS3配置影梭教程
       </li>
	  </a>	
	...
	<section class="panel b-light text-center m-t">
	<header class="panel-heading bg-primary">
        <a href="help/proxifier.php"><i> <img src="./theme/freedom/images/jiaocheng/5.png" data-evernote-hover-show="true"></i>
        
         </a></header><a href="help/proxifier.php">  
       <li class="list-group-item">
            Proxifier实现影梭为外服游戏加速教程
       </li>
	  </a>	
       </section> 
     </div>
...
<footer id="footer">
	...
	<div class="bg-dark dker wrapper">
		<div class="container text-center m-t-lg">
			...
			<div class="m-t-xl m-b-xl">
				<p> 
            <a href="help.php#content" data-jump="true" class="btn btn-icon btn-rounded btn-dark b-dark bg-empty m-sm text-muted"><i class="fa fa-angle-up"></i></a>
          	</p>
			</div>
			<div class="m-t-xl m-b-xl">
				<p> 
