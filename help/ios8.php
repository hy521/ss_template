            ...
            <div class="post-item">
            	<div class="post-media">
                  ...
                  <div class="carousel auto slide panel-body" id="c-fade">      
                     ...
                     <span class="h1">iOS8越狱配置影梭客户端教程</span>                       
                      </div>                    
                  </div> 
                </section>
            	</div>
              <div class="caption wrapper-lg">                
                  <h2 class="post-title">一、下载iOS越狱系统影梭客户端. </h2>                
				  <div class="post-sum"><p>    
                <a href="http://apt.thebigboss.org/onepackage.php?bundleid=com.linusyang.shadowsocks" class="btn btn-primary m-t m-b">Shadowsocks越狱版下载</a></p>
             <div class="line line-lg"></div>
			 
			 
			 <h2 class="post-title">二、也可以直接在 Cydia 里搜索 Shadowsocks安装. </h2>
			   <div class="post-sum"><p>    
               在桌面点击Cydia图标<br>
	<img src="../theme/freedom/images/0060lm7Tgw1f633vx1g4hj30bw0k2mxo.jpg" class="img-full"><br>
	<img src="../theme/freedom/images/0060lm7Tgw1f633vwku36j30fq0kcdgl.jpg" class="img-full"></p><br>			   
			    <div class="line line-lg"></div>
				
				
			  <h2 class="post-title">三、选择并安装——确定. </h2>
			   <div class="post-sum"><p>    
               
<img src="../theme/freedom/images/0060lm7Tgw1f633vwkr5cj30f10k3jrz.jpg" class="img-full"><br>
<img src="../theme/freedom/images/0060lm7Tgw1f633vw4km5j30fn0jzq3b.jpg" class="img-full"></p><br>
			   <div class="line line-lg"></div>
			   
			   
			   
			  <h2 class="post-title">四、安装过程如图——完成点击回到cydia. </h2>			  
			   <div class="post-sum"><p><img src="../theme/freedom/images/0060lm7Tgw1f633vwze1uj30fa0kl3yn.jpg" class="img-full"><br>
<img src="../theme/freedom/images/0060lm7Tgw1f633vwnlgtj30fg0k075t.jpg" class="img-full"></p>
			 <br>	  
                </div>	
                <div class="line line-lg"></div>	
			  ...
			  <h2 class="post-title">五、回到桌面点击影梭图标进入程序. </h2>			  
			   <div class="post-sum"><p><img src="../theme/freedom/images/0060lm7Tgw1f633vxdzapj30fd0mbjsh.jpg" class="img-full"></p>
			 <br>	  
                </div>	
                <div class="line line-lg"></div>
				
				<h2 class="post-title">六、勾选——启用代理——设置端口、账号、密码、加密方式——勾选自动代理. </h2>			  
			   <div class="post-sum"><p><img src="../theme/freedom/images/0060lm7Tgw1f633vydicij30eh0nd3z9.jpg" class="img-full"></p>
			 <br>	  
                </div>	
                <div class="line line-lg"></div>
				
			
				<h2 class="post-title">七、测试是否OK. </h2>			  
			   <div class="post-sum"><p><img src="../theme/freedom/images/0060lm7Tgw1f633vxc0x9j30bv0kigmr.jpg" class="img-full"><br><br><br><img src="../theme/freedom/images/0060lm7Tgw1f633zvn6yyj30c20kv40o.jpg" class="img-full"><br><br>如果你的浏览器可以正常访问诸如 Google、YouTube、Twitter、Facebook 之类的在国内消失了的网站，<br>
	那么就恭喜你，用 影梭 科学上网方式成功！</p><br>
			 <br>	  
                </div>	
                <div class="line line-lg"></div>
                ...
                <div class="text-muted">
                  ...
                  <i class="fa fa-user icon-muted"></i><a href="../user.1.php" class="m-r-sm">会员中心</a>
                </div>
              </div>
            </div>
          </div>
	...
	<div class="bg-dark dker wrapper">
		<div class="container text-center m-t-lg">
			...
			<div class="m-t-xl m-b-xl">
				<p> 
            <a href="ios8.php#content" data-jump="true" class="btn btn-icon btn-rounded btn-dark b-dark bg-empty m-sm text-muted"><i class="fa fa-angle-up"></i></a>
          	</p>
			</div>
			<div class="m-t-xl m-b-xl">
				<p> 
